...
@Component({
  selector: 'app-angular-editor-fabric-js',
...
export class FabricjsEditorComponent implements AfterViewInit {
  ...
  brushSize()
  {
    if(this.canvas.freeDrawingBrush)
    {
      ...
      brush.width = parseInt(this.getDrawSize(), 10);
    }
  }
  ...
  {    
    var brush = this.canvas.freeDrawingBrush;
    brush.color = this.getBrushColor();
  }
  ...
  setDrawSize() {    
    this.props.drawSize=this.props.drawSize;
    this.brushSize();
  }
  getDrawSize(){
    return this.props.drawSize;
  }
  setBrushColor()
  {
    this.props.brushColor=this.props.brushColor;
    this.brushColor();
  }
  getBrushColor()
  {
    return this.props.brushColor;
  }
